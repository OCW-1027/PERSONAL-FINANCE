...
const LANG = {
  ko: {
    ...
    dataUpdAsk: "새로운 데이터가 있습니다.\n전표 {n}건 ({m}엔)을 추가할까요?\n\n※ 기존 데이터는 유지되며, 중복은 자동으로 제외됩니다.",
    dataUpdDone: "전표 {n}건을 추가했습니다",
    aggregate: "종합과세",
    ...
    tabTB: "시산표",
    tabExp: "비용분석",
    expNote: "※ 사업분(가사안분 후) 기준. 개업 전 지출은 개업비로 별도 관리됩니다.",
    alFiling: "{y}년분 확정신고",
    alFilingSub: "2/16~3/15 e-Tax 제출",
    alBlue: "청색신고 승인신청서 제출기한",
    alBlueSub: "놓치면 65만 공제 불가",
    alConsump: "소비세 과세사업자 선택신고서",
    alConsumpSub: "환급을 받을 경우 연말까지",
    alAllowance: "자녀장애 수당 현황신고",
    alAllowanceSub: "매년 8월 시청 제출",
    alPrepay: "예정납세 1기분",
    alPrepaySub: "전년 소득세 15만엔 이상 시",
    code: "코드",
    drBal: "차변잔액",
    crBal: "대변잔액",
    tbMatch: "차변 합계 = 대변 합계 ✓",
    tbDiff: "차대 불일치 {n} — 전표를 확인하세요",
    plTitle: "손익계산서 (사업소득)",
    plRev: "수입금액",
    plExp: "필요경비",
    plNet: "차인금액 (공제 전)",
    bizIncomeAmt: "사업소득 금액",
    unitYen: "단위: 엔",
    fyChanged: "{y}년으로 전환했습니다",
    rollTitle: "연도 이월",
    rollNote: "당해 연도를 마감하고 다음 연도로 넘깁니다. 元入金(원입금)이 자동 계산됩니다: 전년 원입금 + 소득 + 사업주차 − 사업주대. 실행 전 자동 백업됩니다.",
    rollBtn: "{a}년 마감 → {b}년 개시",
    rollConfirm: "{a}년을 마감하고 {b}년으로 넘깁니다. 계속할까요?",
    rollDone: "{y}년으로 전환했습니다. 元入金 = {n}",
    // --- 마법사 ---
    welcome: "환영합니다",
  ...
  ja: {
    ...
    dataUpdAsk: "新しいデータがあります。\n伝票 {n}件 ({m}円) を追加しますか？\n\n※ 既存データは保持され、重複は自動的に除外されます。",
    dataUpdDone: "伝票 {n}件を追加しました",
    aggregate: "総合課税",
    ...
    tabTB: "試算表",
    tabExp: "費用分析",
    expNote: "※ 事業分(家事按分後)ベース。開業前の支出は開業費として別管理されます。",
    alFiling: "{y}年分 確定申告",
    alFilingSub: "2/16~3/15 e-Tax提出",
    alBlue: "青色申告承認申請書 提出期限",
    alBlueSub: "逃すと65万控除不可",
    alConsump: "消費税課税事業者選択届出書",
    alConsumpSub: "還付を受ける場合は年末まで",
    alAllowance: "障害児手当 現況届",
    alAllowanceSub: "毎年8月 市役所提出",
    alPrepay: "予定納税 第1期分",
    alPrepaySub: "前年所得税15万円以上の場合",
    code: "コード",
    drBal: "借方残高",
    crBal: "貸方残高",
    tbMatch: "借方合計 = 貸方合計 ✓",
    tbDiff: "貸借不一致 {n} — 伝票を確認してください",
    plTitle: "損益計算書 (事業所得)",
    plRev: "収入金額",
    plExp: "必要経費",
    plNet: "差引金額 (控除前)",
    bizIncomeAmt: "事業所得金額",
    unitYen: "単位: 円",
    fyChanged: "{y}年に切り替えました",
    rollTitle: "年度繰越",
    rollNote: "当年度を締めて翌年度へ繰り越します。元入金が自動計算されます: 前年元入金 + 所得 + 事業主借 − 事業主貸。実行前に自動バックアップします。",
    rollBtn: "{a}年 締め → {b}年 開始",
    rollConfirm: "{a}年を締めて{b}年へ繰り越します。続けますか？",
    rollDone: "{y}年に切り替えました。元入金 = {n}",
    welcome: "ようこそ",
